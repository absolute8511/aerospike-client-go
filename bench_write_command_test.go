...
func Benchmark_WriteCommand_________Int64(b *testing.B) {
...
func Benchmark_WriteCommand_String______1(b *testing.B) {
	set := "put_bench_str_1"
...
func Benchmark_WriteCommand_String_____10(b *testing.B) {
...
func Benchmark_WriteCommand_String____100(b *testing.B) {
...
func Benchmark_WriteCommand_String__10000(b *testing.B) {
...
func Benchmark_WriteCommand_String_100000(b *testing.B) {
	set := "put_bench_str_10000"
